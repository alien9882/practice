 ...
 * 
 * @param { 
 *  captureCallback: 拍照後要執行的function
 *  watermark: {
 *    template: 浮水印樣式html
 *  }
 * } options 
 */
var CameraPlugin = function (options) {
  var self = this;
  ...
  function initCameraUI() {
    ...
    if (screenfull.isEnabled) {
      ...
      toggleFullScreenButton.addEventListener('click', function () {
        screenfull.toggle(document.getElementById('camUI')).then(function () {
          console.log(
            'Fullscreen mode: ' +
  ...
  function takeSnapshot() {
    ...
    if(!!options.captureCallback) {
      options.captureCallback.call(this,imgdata);
    }
